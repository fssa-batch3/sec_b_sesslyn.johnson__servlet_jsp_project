				...
				<div class="slider-item">
					...
					<div class="slide">
						<figure class="slide-image">
							<img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWFsZSUyMHByb2ZpbGV8ZW58MHx8MHx8fDA%3D&w=1000&q=80"
						...
						<div class="row">
							<p class="project">Id : <%=designer.getId()%></p>
							<strong>.</strong>
						...
						<div class="row custom-row">
							...
							<button class="viewMore" data-id="designerId">View More</button></a>
						</div>
					</div>
					<%
					}
