        ...
        <section class="table__body">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><%=index + 1%></td>
                        <td><%=appointment.getFromUser().getName()%><br> <small><%=appointment.getFromUser().getEmail()%></small></td>
                        <td id="designer">
                            <%
                        ...
                        <td id="statusInfo">
                            <details class="dropdown">
                                <summary role="button">
                                    <p class="status <%=appointment.getStatus().toLowerCase()%>"><%=appointment.getStatus()%></p>
                                </summary>
                            </details>
                        </td>
                    </tr>
