...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/css/designer/design_form.css">
</head>
<style>
.form-control {
	border: none;
...
<body>
	...
	<%
	Design design = (Design) request.getAttribute("designDetails");
	Asset asset = (Asset) request.getAttribute("assetDetails");
						...
						<div class="form-row">
							<div class="form-holder">
								<input type="text" name="design_name" placeholder="Design Name"
									...
									title="Only Alphabets and numbers with space between"
							...
							<div class="form-holder">
								<input type="text" name="customer_name"
									...
									value="<%=(design != null) ? StringUtil.extractValue("Customer_Name", design.getDescription()) : ""%>">
							</div>
						</div>
						<div class="form-row">
							<div class="form-holder">
						...
						<div class="form-row">
							<div class="form-holder w-100">
								<input type="text" name="location"
									...
									required title="Only Alphabets with a single space between"
									class="form-control">
							</div>
						</div>
						<div class="form-row">
							<div class="form-holder">
								<select class="form-control" name="style" required>
									...
									<option value="<%=style2.getId()%>" class="status"
										<%if (style2.getId() == styleId) {%> selected <%}%>>
										<%=style2.getName()%>
									</option>
									<%
									}
						...
						<div class="form-row">
							<div class="form-holder w-100">
								<textarea name="design_description" id="design_description"
									pattern="^(?!.*\s{2})[^\s].*[^\s]$"
									value="<%=(design != null) ? design.getDescription() : ""%>"
									placeholder="Design Description" required minlength="30"
									class="form-control" style="height: 99px;"></textarea>
