...
<body>
   ...
   <% 
    ...
    ProductRespondDTO product = (ProductRespondDTO) request.getAttribute("productDetails");
    System.out.println(product);
    int categoryId = product.getCategoryId().getId();
  %>
	...
	<div class="wrapper">
		<div class="inner">
			<div class="image-holder">
				<img
					src="https://iili.io/HgVcbdQ.png"
					id="update_image" alt="idea with the bulb">
			</div>
			<form action="<%=request.getContextPath()%>/seller/product/update"
				method="post">
				<h3>Start Selling</h3>
	...
	<script src="<%=request.getContextPath()%>/assets/js/chatBot.js"></script>
	<script
		src="<%=request.getContextPath()%>/assets/comments/seller_header.js"></script>
