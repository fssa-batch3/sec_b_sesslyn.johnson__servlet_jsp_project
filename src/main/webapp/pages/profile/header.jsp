	...
	<div class="head">
		<div class="main_header">
			<span class="header" id="header_shop"> <a
				href="<%=request.getContextPath()%>/pages/profile/home_page.html">
					<img class="main_logo" id="main_logo"
					src="https://iili.io/Hy0p6kx.jpg" alt="logo of minimalistic" />
			</a>
			</span>
			...
			%>
			<a href="<%=request.getContextPath()%>/pages/product/cart.html"> <img src="https://iili.io/HyVDSHu.png"
