...
.header__wrapper header {
  width: 100%;
  background: url("<%=request.getContextPath()%>/assets/images/home_page/bg.jpeg") no-repeat 50% 20% / cover;
		...
		<div class="cols__container">
			<div class="left__col">
				<div class="img__container">
					<img src="<%=user.getImage()%>" alt="Anna Smith" /> 
			...
			<div class="right__col">
				<div class="flex">
					...
					<div class="photos">
						<img
							src="<%=request.getContextPath()%>/assets/images/home_page/img_<%=i + 2%>.avif"
